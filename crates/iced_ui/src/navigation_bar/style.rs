//! Styling primitives for the [`NavigationBar`](super::NavigationBar) widget.
...
/// The visual style of the [`NavigationBar`](super::NavigationBar) widget.
...
/// Catalog of theme-driven styles for a [`NavigationBar`](super::NavigationBar) widget.
pub trait Catalog {
...
/// The default navigation bar style following Material Design 3 conventions.
///
